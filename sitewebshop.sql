...
--
-- Serveur: 127.0.0.1
-- Généré le : Mer 07 Octobre 2015 à 12:38
...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  `mot_de_passe` varchar(150) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `civilite` varchar(32) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `nom` varchar(64) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `prenom` varchar(64) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `adresse` varchar(255) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `code_postal` int(5) NOT NULL DEFAULT '0',
  `ville` varchar(64) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `pays` varchar(32) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `telephone` int(10) NOT NULL DEFAULT '0',
  `img_client` varchar(64) CHARACTER SET latin1 NOT NULL DEFAULT 'images/default_logo_user.png',
